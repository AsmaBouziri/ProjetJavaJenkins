	...
	public AjouterPatient() {
		...
		enregistrerButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sexe = hommeRB.isSelected() ? "Homme" : "Femme";
		...
		enregistrerButton.setFont(new Font("Tahoma", Font.BOLD, 15));
		enregistrerButton.setBounds(166, 380, 141, 23);
		...
		annulerButton.setFont(new Font("Tahoma", Font.BOLD, 15));
		annulerButton.setBounds(460, 380, 141, 23);
